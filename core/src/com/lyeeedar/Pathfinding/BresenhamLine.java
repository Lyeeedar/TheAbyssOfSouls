...
public class BresenhamLine
{
	...
	public static Array<Point> lineNoDiag( int x0, int y0, int x1, int y1, PathfindingTile[][] Grid, boolean checkPassable, int range, EnumBitflag<Enums.SpaceSlot> travelType, Object self )
	{
	...
	public static Array<Point> line( int x, int y, int x2, int y2, PathfindingTile[][] Grid, boolean checkPassable, int range, EnumBitflag<Enums.SpaceSlot> travelType, Object self )
	{
